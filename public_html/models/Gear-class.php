...
class Gear {
	...
	public function setIsDisables($isDisabled) {
	...
	public function finalize() {
		...
		if(!isset($this->gear_id)){
			...
			$sql = "UPDATE gear SET name='$name', gear_type_id='$this->type', qty='$this->qty', isDisabled='$this->isDisabled', notes='$this->notes' WHERE gear_id='$this->gear_id'";
		}
		$database->query($sql);
	}
	...
	//returns an array of all Gear objects with type
